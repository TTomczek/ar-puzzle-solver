...
interface ArModelStrategy {
    ...
    fun createModel(entity: PuzzleEntity, anchor: Anchor, viewNodeWindowManager: ViewNode2.WindowManager, materialLoader: MaterialLoader,engine: Engine): AnchorNode?
}